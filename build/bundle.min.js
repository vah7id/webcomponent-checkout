(function () {
  ...
  */
  ...
  var skuValidator = (item, modelValue) => {
  ...
  class BasketItem extends HTMLElement {
    ...
    connectedCallback() {
      ...
      var _render = () => {
        var tmp = html(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n            <div class=\"basket-item\">\n                \n                <span>", "x</span>\n                <span>", "</span>\n                <small>", "</small>\n                \n                <button @click=", " class=\"btn-delete\">X Remove from basket</button>\n    \n                <lion-input-stepper \n                    class=\"input-stepper-wrapper\"\n                    step=\"1\" \n                    min=\"1\" \n                    name=\"quantity\"\n                    value=", " \n                    max=", " \n                    @click=", "\n                    @keyup=", "\n                    .validators=\"", "\">\n                </lion-input-stepper>\n                \n            </div>"])), this.item.quantity, this.item.title, this.item.deliveryTime, () => this.removeItem(this.item), this.item.quantity, this.item.availableStock, e => updateQuantity(e), e => updateQuantity(e), [new MaxLength(1, {
          getMessage: _ref => {
            var {
              modelValue
            } = _ref;
            return skuValidator(this.item, modelValue);
          }
        })]);
        render$1(tmp, this);
      };
  ...
  class Basket extends HTMLElement {
    ...
    connectedCallback() {
      ...
      var _render = () => {
        var tmp = html(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n            <div class=\"basket-wrapper\">\n                ", "\n                ", "\n            </div>"])), this.basketItems.map(item => html(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral(["\n                    <basket-item \n                        .updateItem=", " \n                        .removeItem=", " \n                        .item=", ">\n                    </basket-item>"])), updateItem, removeItem, item)), this.basketItems.filter(Boolean).length === 0 ? html(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["\n                    <h3>BASKET IS EMPTY!! GO SHOPPING :)</h3><button>Go to homepage</button>"]))) : html(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["<button @click=", ">Next step</button>"])), () => this.handleStepChange(2)));
        render$1(tmp, this);
      };
  ...
  var validatePayment = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (orderId, paymentId) {
    ...
    return function validatePayment(_x, _x2) {
      return _ref.apply(this, arguments);
    };
  }();

  var fetchPaymentOptions = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(function* () {
      return fetch("/assets/mocks/payment_options.json").then(res => res.json());
    });

    return function fetchPaymentOptions() {
      return _ref2.apply(this, arguments);
    };
  }();

  var reserveBasket = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(function* (basketItems) {
    ...
    return function reserveBasket(_x3) {
  ...
  class Delivery extends HTMLElement {
    ...
    connectedCallback() {
      ...
      var confirmDeliveryAddress = () => {
        var deliveryAddress = []; // update the delivery address in global state
  ...
  class StepsTab extends HTMLElement {
    ...
    _render() {
      var tmp = html(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n            <lion-step class=\"step-item\" initial-step>\n                <label class=", ">1 Basket</label>\n            </lion-step>\n            <lion-step class=\"step-item\">\n                <label class=", ">2 Delivery</label>\n            </lion-step>\n            <lion-step class=\"step-item\">\n                <label class=", ">3 Payment</label>\n            </lion-step>\n            <lion-step class=\"step-item\">\n                <label class=", ">4 Confirmation</label>\n            </lion-step>\n           "])), this.selectedStep === 1 ? 'step-active' : '', this.selectedStep === 2 ? 'step-active' : '', this.selectedStep === 3 ? 'step-active' : '', this.selectedStep === 4 ? 'step-active' : '');
      render$1(tmp, this);
    }
  ...
  var getBasketItems = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* () {
      return fetch("/assets/mocks/basket.json").then(res => res.json());
    });

    return function getBasketItems() {
      return _ref.apply(this, arguments);
    };
  }();
