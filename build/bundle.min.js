  ...
  class Delivery extends HTMLElement {
    ...
    connectedCallback() {
      ...
      var confirmDeliveryAddress = () => {
        ...
        if (!this.hasVoucher) {
          var addressFields = ['street', 'houseNumber', 'houseNumberAddition', 'postalCode', 'city'];
      ...
      var _render = () => {
        var tmp = html(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["<div class=\"delivery-wrapper\">\n            <h2>Delivery information</h2>\n            <form name=\"addressFields\">\n                <input type=\"text\" .value=", " name=\"fullname\" placeholder=\"Full name\"></input>\n                <input type=\"email\" .value=", " name=\"email\" placeholder=\"Email\" ></input>\n                ", "\n                <input type=\"text\" .value=", " name=\"phone\" placeholder=\"Phone\" ></input>\n            </form>\n            <footer>\n                <button @click=", ">previous step</button>\n                <button class=\"btn-primary\" @click=", ">Next step</button>\n            </footer>"])), this.customer.fullname, this.customer.email, !this.hasVoucher ? html(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n                <input type=\"text\" .value=", " id=\"street\" name=\"street\" placeholder=\"Street\" ></input>\n                <input type=\"text\" .value=", " id=\"houseNumber\" name=\"houseNumber\" placeholder=\"House number\" ></input>\n                <input type=\"text\" .value=", " id=\"houseNumberAddition\" name=\"houseNumberAddition\" placeholder=\"Additional House Number\" ></input>\n                <input type=\"text\" .value=", " id=\"postalCode\" name=\"postalCode\" placeholder=\"Postal Code\" ></input>\n                <input type=\"text\" .value=", " id=\"city\" name=\"city\" placeholder=\"City\" ></input>"])), this.customer.address.street, this.customer.address.houseNumber, this.customer.address.houseNumberAddition, this.customer.address.postalCode, this.customer.address.city) : "", this.customer.phone, () => this.handleStepChange(1), () => confirmDeliveryAddress());
        render$1(tmp, this);
      };
    }
  ...
  class Steps extends HTMLElement {
    ...
    connectedCallback() {
      ...
      var removeBasketItem = item => {
        var idx = this.basketItems.findIndex(_item => _item ? _item.productId === item.productId : false);
      ...
      var _render = () => {
        var tmp = html(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<lion-steps class=\"steps-wrapper\">\n            \n                <lion-step class=\"step-item\" initial-step>\n                    <label class=", ">1 Basket</label>\n                </lion-step>\n                <lion-step class=\"step-item\">\n                    <label class=", ">2 Delivery</label>\n                </lion-step>\n                <lion-step class=\"step-item\">\n                    <label class=", ">3 Payment</label>\n                </lion-step>\n                <lion-step class=\"step-item\">\n                    <label class=", ">4 Confirmation</label>\n                </lion-step>\n        \n                <div class=\"step-container\">\n                    ", "\n                    ", "\n                    ", "\n                    ", "\n                </div>\n\n            </lion-steps>"])), this.step === 1 ? 'step-active' : '', this.step === 2 ? 'step-active' : '', this.step === 3 ? 'step-active' : '', this.step === 4 ? 'step-active' : '', this.step === 1 ? html(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<basket-step .updateBasketItem=", " .removeBasketItem=", " .basketItems=", " .handleStepChange=", "></basket-step>"])), updateBasketItem, removeBasketItem, this.basketItems, handleStepChange.bind(this)) : "", this.step === 2 ? html(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<delivery-step .basketItems=", " .handleDeliveryAddress=", " .handleStepChange=", "></delivery-step>"])), this.basketItems, handleDeliveryAddress.bind(this), handleStepChange.bind(this)) : "", this.step === 3 ? html(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<payment-step .basketItems=", " .handleStepChange=", "></payment-step>"])), this.basketItems, handleStepChange.bind(this)) : "", this.step === 4 ? html(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["<confirmation-step .deliveryAddress=", " .basketItems=", "></confirmation-step>"])), this.deliveryAddress, this.basketItems) : "");
        render$1(tmp, this);
      };
    }
